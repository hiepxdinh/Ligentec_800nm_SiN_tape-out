...
from Aux_ring import Aux_add_drop_ring_1_2, Aux_add_drop_ring_3


class Aux_add_drop_ring_taper_1_2(i3.Circuit):
    ...
    ring_gap = i3.PositiveNumberProperty(default=0.45, doc="the gap ")
    ...
    def _default_insts(self):
        return {"aux_ring": self.aux_ring,
                ...
                "in_ref_taper": self.taper,
                "out_ref_taper": self.taper,
                ...
                "linear_transition_ref_in": self.linear_transition,
                "linear_transition_ref_out": self.linear_transition,
                }
    ...
    def _default_specs(self):
        return [
            ...
            i3.Place('in_ref_taper',position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, -100 + 212 - 127 + 55.12 - 127 - 127), angle=0,relative_to="aux_ring:through"),

            i3.Place('out_ref_taper',position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, 100 - 212 + 127 - 55.12 + 127 + 127), angle=0,relative_to="aux_ring:drop"),

            i3.Place("linear_transition_ref_in", position=(-115, 0), angle=0, relative_to="in_ref_taper:in0"),
            # i3.FlipH("linear_transition_in"),
            i3.Place("linear_transition_ref_out", position=(-115, 0), angle=0, relative_to="out_ref_taper:in0"),

            i3.ConnectBend("linear_transition_ref_in:out0", "in_ref_taper:in0"),
            i3.ConnectBend("linear_transition_ref_out:out0", "out_ref_taper:in0"),

            i3.ConnectManhattan("linear_transition_ref_in:in0", "linear_transition_ref_out:in0",
                                control_points=[i3.V(i3.START - 775),
                                                ],
                                bend_radius=50,
                                ),
    ...
    class Layout(i3.Circuit.Layout):
        ...
        def _default_aux_ring(self):
            ...
            lo.set(ring_gap=self.ring_gap)
            lo.set(main_gap0=self.main_gap0)
            lo.set(main_gap1=self.main_gap1)
            lo.set(aux_gap0=self.aux_gap0)
...
class Aux_add_drop_ring_taper_3(i3.Circuit):
    ...
    ring_gap = i3.PositiveNumberProperty(default=1.0, doc="the gap ")
    main_gap0 = i3.PositiveNumberProperty(doc="Gap between ring and coupler [um]", default=1.0)
    main_gap1 = i3.PositiveNumberProperty(doc="Gap between ring and coupler [um]", default=1.0)
    aux_gap0 = i3.PositiveNumberProperty(doc="Gap between ring and coupler [um]", default=1.0)
    ...
    def _default_specs(self):
        return [
            i3.Place('aux_ring', position=self.ring_position, angle=0),
            i3.Place('through_taper',
                     position=(-500 + 1500 - 250 - 75 - 75 + 50 + 50, 0 + 239 - 127 + 55.12 - 127), angle=0,
                     relative_to="aux_ring:in"),
            i3.Place('in_taper',
                     position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, -100 + 212 - 127 + 55.12 - 127), angle=0,
                     relative_to="aux_ring:through"),
            i3.Place('drop_taper',
                     position=(-500 + 1500 - 250 - 75 - 75 + 50 + 50, 0 - 239 + 127 - 55.12 + 127), angle=0,
                     relative_to="aux_ring:add"),
            i3.Place('add_taper',
                     position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, 100 - 212 + 127 - 55.12 + 127), angle=0,
            ...
            i3.Place('in_ref_taper',
                     position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, -100 + 212 - 127 + 55.12 - 127-127), angle=0,
                     relative_to="aux_ring:through"),

            i3.Place('out_ref_taper',
                     position=(-600 + 1500 - 250 - 75 - 75 + 50 + 50, 100 - 212 + 127 - 55.12 + 127+127), angle=0,
                     relative_to="aux_ring:drop"),
            ...
            # #
            i3.Place("linear_transition_aux_in", position=(-115, 0), angle=0, relative_to="aux_in_taper:in0"),
            i3.Place("linear_transition_aux_through", position=(-115, 0), angle=0,
                     relative_to="aux_through_taper:in0"),
    ...
    class Layout(i3.Circuit.Layout):
        horizontal_spacing = i3.PositiveNumberProperty(default=9000,
                                                       doc="horizontal spacing between input and output inverse_taper couplers")
        ring_radius = i3.PositiveNumberProperty(default=100.0, doc="radius of the ring")
        ring_position_x = i3.NumberProperty(default=0.0, doc="the x position of ring")
        ring_position_y = i3.NumberProperty(default=0.0, doc="the y position of ring")
        ebl_field_size = i3.PositiveNumberProperty(default=100.0, doc="the ebl writing field size")
