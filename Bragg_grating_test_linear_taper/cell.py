...
class BG_Test_1_taper(i3.Circuit):
    ...
    def _default_specs(self):
        return [
            i3.Place("linear_taper_out", (0, 0)),
            i3.Place("grating:in0", (-10, 0), angle=0, relative_to="linear_taper_out:in0"),
            i3.Place("tip_extension:in0", (0, 0), relative_to="linear_taper_out:out0"),
            i3.ConnectBend("grating:in0", "linear_taper_out:in0"),
...
class BG_Test_2_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_3_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_4_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_5_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_6_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_7_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
class BG_Test_8_taper(i3.Circuit):
    grating = i3.ChildCellProperty(doc="grating")
    linear_taper_out = i3.ChildCellProperty(doc="linear taper")
    tip_extension = i3.ChildCellProperty("tip extension")
...
# class BG_Test_9_taper(i3.Circuit):
#     grating = i3.ChildCellProperty(doc="grating")
#     linear_taper_out = i3.ChildCellProperty(doc="linear taper")
#     tip_extension = i3.ChildCellProperty("tip extension")
#
