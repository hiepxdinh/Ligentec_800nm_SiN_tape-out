...
class Exspot_Spiral_Square(i3.Circuit):
    ...
    class Layout(i3.Circuit.Layout):
        ...
        def _generate_elements(self, elems):
            ...
            elems += i3.PolygonText(
                layer=i3.TECH.PPLAYER.CELLNAME,
                coordinate=(out_x-110-0, out_y+30),
                text="SPIRAL_" +str(self.spiral_length) + "_" +str(self.width_out),
                alignment=(i3.TEXT.ALIGN.CENTER, i3.TEXT.ALIGN.CENTER),
                font=i3.TEXT.FONT.DEFAULT,
                height=10,
...
class Exspot_Spiral_Circular(i3.Circuit):
    ...
    def _default_specs(self):
        return[
            ...
            i3.Place("exspot_in", position=(1000.0, 155.0), angle=0, relative_to="spiral:in0"),
            i3.Place("exspot_out", position=(-1000.0, 0.0), angle=180, relative_to="spiral:in0"),

            i3.Place("linear_taper_in", position=(-115, 0.0), angle=0, relative_to="exspot_in:in0"),
            ...
            i3.ConnectManhattan("spiral:in0", "linear_taper_in:in0",
                control_points=[i3.H(i3.START)
                                ],
                           ),
    ...
    class Layout(i3.Circuit.Layout):
        spiral_length = i3.PositiveNumberProperty(default=25000, doc="length of spiral")
