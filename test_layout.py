...
ring_lv = ring.Layout(ring_radius=radius)
# ring_lv.visualize(annotate=True)
chip_elements.append(i3.SRef(reference=ring, position=(7895 + 200*1-2500+1000+725, 3615+155-200), transformation=i3.Rotation(rotation=90)))

ring = Add_drop_ring_Exspot_100GHz(ring_position_x=0, ring_position_y=0, output_offset=0)
ring_lv = ring.Layout(ring_radius=radius)
# ring_lv.visualize(annotate=True)
chip_elements.append(i3.SRef(reference=ring, position=(7895 + 200*1-2500+1000+725+725, 3615+155-200), transformation=i3.Rotation(rotation=90)))
...
chip_elements.append(i3.SRef(reference=aux_ring, position=(9000, 3500+125), transformation=i3.Rotation(rotation=-90)+i3.VMirror()))
